# Claude command parity

Codex skills use the same command names with `$` in place of Claude Code’s `/`.
...
- `$big-guns [focus]` performs an optional deep review.

The common outcome, user gates, artifact ownership, verification, and approvals are defined by `WORKFLOW.md`.
